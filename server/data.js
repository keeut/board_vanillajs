...
export const changeData = (text,title,author,num,date)=>{
    const newData = {num, title, author, date}
    const newContent = {num , content:text}
    deleteData(num)
    datas.push(newData)
    contentsData.push(newContent)
}

export const AddData = (text,title,author,num,date)=>{
    const newData = {num, title, author, date}
    const newContent = {num , content:text}
    datas.push(newData)
    contentsData.push(newContent)
